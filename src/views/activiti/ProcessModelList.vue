    ...
    <a-table :scroll="{x:2200,y:500}" bordered
      ...
      <a-table-column title="操作" dataIndex="" align="center" :width="250" fixed='right'>
        <template slot-scope="t,r,i">
          ...
          <a href="javascript:void(0);" v-if="r.status!=1" @click="editStatus(1,r)"
    ...
    >
      <a-form :form="editForm" v-if="editObj.visible">
        ...
        <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" label="角色授权">
          <j-select-role placeholder="不选择则所有人可用"
        ...
        <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" label="备注描述">
          <a-textarea v-decorator="[ 'description', {initialValue:editObj.description, rules: []}]"
                      placeholder="备注描述" :autoSize="{ minRows: 3, maxRows: 5 }"/>
        </a-form-item>
      </a-form>
    </a-modal>
    <!--节点设置-->
      ...
      <a-row>
        ...
        <a-col :md="20" :sm="20">
          ...
          <a-form :form="nodeForm" v-if="showProcessNodeEdit">
            ...
            <!--            0角色 1用户 2部门 3发起人 4发起人的部门负责人-->
            <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" label="选择角色"
            ...
            <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" label="选择部门"
